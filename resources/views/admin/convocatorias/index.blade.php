    ...
    <div class="py-10">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                        ...
                        <tbody class="divide-y divide-gray-100 bg-white">
                            ...
                            <tr class="transition hover:bg-emerald-50/40">
                                ...
                                <td class="whitespace-nowrap px-6 py-5">
                                    ...
                                    <div class="mt-2">
                                        <span
                                            class="inline-flex rounded-full border border-violet-200 bg-violet-50 px-3 py-1 text-xs font-extrabold text-violet-700">
                                            Resultados públicos
                                        </span>
                                    </div>
                                    @endif
            ...
            $convocatoria->id
                   ...
                   text-sm font-extrabold text-violet-800
                   transition hover:bg-violet-100">
                                        ...
                                        <form
                                            method="POST"
                                            action="{{ route('admin.convocatorias.destroy', $convocatoria->id) }}"
