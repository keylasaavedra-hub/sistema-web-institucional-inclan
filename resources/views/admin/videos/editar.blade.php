<x-app-layout>
    ...
    <div class="py-8">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <form
                action="{{ route('admin.videos.actualizar', $video) }}"
                method="POST"
                            ...
                            <div class="mt-7 grid gap-6 sm:grid-cols-2">
                                ...
                                <div>
                                    ...
                                    <select
                                        ...
                                        <option
                                            value="{{ $valor }}"
                                            @selected(old('categoria', $video->categoria) === $valor)
                                            >
                                            {{ $etiqueta }}
                                        </option>
                                        @endforeach
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        value="{{ old('fecha_publicacion', $video->fecha_publicacion?->format('Y-m-d')) }}"
                                        class="h-12 w-full rounded-xl border-gray-200 bg-gray-50 text-sm focus:border-amber-400 focus:ring-amber-400">
                                </div>
                                ...
                                <div class="sm:col-span-2">
                                    ...
                                    <textarea
                                        ...
                                        class="w-full rounded-xl border-gray-200 bg-gray-50 text-sm leading-6 focus:border-amber-400 focus:ring-amber-400">{{ old('descripcion', $video->descripcion) }}</textarea>
                                </div>
                                ...
                                <div class="space-y-3">
                                    <label class="flex cursor-pointer items-center gap-4 rounded-2xl border border-amber-200 bg-amber-50 px-5 py-4">
                                        ...
                                        <input
                                            ...
                                            name="destacado"
                                            value="1"
                                            @checked(old('destacado', $video->destacado))
                                    ...
                                    <label class="flex cursor-pointer items-center gap-4 rounded-2xl border border-emerald-200 bg-emerald-50 px-5 py-4">
                                        ...
                                        <input
                                            ...
                                            name="estado"
                                            value="1"
                                            @checked(old('estado', $video->estado))
                                        class="h-5 w-5 rounded border-gray-300 text-emerald-700 focus:ring-amber-400"
                                        >
